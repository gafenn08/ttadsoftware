 ...
 */
function ttad_button($variables) {
 ...
 */
function ttad_menu_local_tasks(&$variables) {
  $output = '';
 ...
 */
function ttad_menu_local_action($variables) {
 ...
 */
function ttad_menu_local_task($variables) {
  $link = $variables['element']['#link'];
 ...
 */
function ttad_checkbox($variables) {
 ...
 */
function ttad_checkboxes($variables) {
  // Redefine #children:
  $option_children = '';
 ...
 */
function ttad_form_element($variables) {
  $element = &$variables['element'];
 ...
 */
function ttad_form_element_label($variables) {
  $element = $variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
 ...
 */
function ttad_radios($variables) {
  // Redefine #children:
  $option_children = '';
  foreach ($variables['element']['#options'] as $key => $description) {
    $option_variables = array(
 ...
 */
function ttad_textarea($variables) {
  $element = $variables['element'];
 ...
 */
function ttad_textfield($variables) {
  $element = $variables['element'];
 ...
 */
function ttad_password($variables) {
  $element = $variables['element'];
