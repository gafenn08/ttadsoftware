    ...
    <div class="row">
      <div class="twelve columns footer-full"> 
        ...
        <div class="after_footer">
        	<div class="copyright"><?php echo theme_get_setting('secondary_footer_text'); ?></div>
        	<div class="legal"><a href="/privacy_policy">Privacy Policy</a><a href="/terms_of_service">Terms of Service</a><a href="/user_agreement">User Agreement</a></div>
        </div>
        <?php } else { print '<div class="row"'.render($page['footer_full']). '</div>'; }?>  
      </div> 
    </div>
    <?php } ?>
